...
urlpatterns = [
    ...
    path('billing_records_main/export/', views.export_bills_report, name='export_bills_report'),
    ...
    path('payments_main/export/', views.export_payments_report, name='export_payments_report'),
